...
public class HyphinityFern extends DoublePlantBlock {
    public static final EnumProperty<DoubleBlockHalf> HALF = BlockStateProperties.DOUBLE_BLOCK_HALF;

    public HyphinityFern(Properties properties) {
...
//        BlockState plant = plantable.getPlant(world, pos.offset(facing));
        ...
        if (state.getBlock() == this && blockstate == RegistryHandler.HYPERLANE_GEL_BLOCK.get().getDefaultState() || state.getBlock() == this && blockstate == RegistryHandler.HYPERLANE_GEL_BLOCK.get().getDefaultState()) {
