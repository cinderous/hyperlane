...
public class HyperlaneGelSlab extends Block implements IWaterLoggable {
    ...
    public HyperlaneGelSlab(Block.Properties properties) {
        super(properties);
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        ...
        return RegistryHandler.HYPERLANE_GEL_SLAB_TILE_ENTITY.get().create();
