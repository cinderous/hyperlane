...
public class HyphinityGrass extends TallGrassBlock {


    protected static final VoxelShape SHAPE = Block.makeCuboidShape(2.0D, 0.0D, 2.0D, 14.0D, 13.0D, 14.0D);

    public HyphinityGrass(Properties properties) {
    ...
    protected boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
        ...
        return (block == RegistryHandler.HYPERLANE_GEL_BLOCK.get() || block == RegistryHandler.HYPHINITY_GEL_BLOCK.get());
