...
public class HyperlaneStaffPedestalBlock extends Block {

    public HyperlaneStaffPedestalBlock(Block.Properties properties) {
        super(properties);
    }
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return RegistryHandler.HYPERLANE_STAFF_PEDESTAL_TILE_ENTITY.get().create();
    }
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player,
        ...
        if (!worldIn.isRemote) {
            ...
            if (tile instanceof HyperlaneStaffPedestalTileEntity) {
                NetworkHooks.openGui((ServerPlayerEntity) player, (HyperlaneStaffPedestalTileEntity) tile, pos);
    ...
    public void onReplaced(BlockState state, World worldIn, BlockPos pos, BlockState newState, boolean isMoving) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (tile instanceof HyperlaneStaffPedestalTileEntity) {
                InventoryHelper.dropItems(worldIn, pos, ((HyperlaneStaffPedestalTileEntity) tile).getItems());
            }
        }
    }
