...
public class CinderbaneGrass extends TallGrassBlock {


    protected static final VoxelShape SHAPE = Block.makeCuboidShape(2.0D, 0.0D, 2.0D, 14.0D, 13.0D, 14.0D);

    public CinderbaneGrass(Block.Properties properties) {
    ...
    public boolean canSustainPlant(BlockState state, IBlockReader world, BlockPos pos, Direction facing, net.minecraftforge.common.IPlantable plantable) {
        ...
        if (blockstate == RegistryHandler.CINDIRT.get().getDefaultState() || blockstate == RegistryHandler.CINDIRT_GRASS.get().getDefaultState()) {
            return true;
        }return false;
    }
