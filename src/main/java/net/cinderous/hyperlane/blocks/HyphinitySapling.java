...
public class HyphinitySapling  extends BushBlock implements IGrowable {
    ...
    public HyphinitySapling(Supplier<Tree> treeIn, Properties properties) {
        super(properties);
        this.tree = treeIn;
    }
    ...
    protected boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
        ...
        return block == RegistryHandler.HYPERLANE_GEL_BLOCK.get() || block == RegistryHandler.HYPERLANE_GRAVEL.get() || block == RegistryHandler.HYPHINITY_SOIL.get() || block == RegistryHandler.HYPHINITY_GEL_BLOCK.get() ;
    }
