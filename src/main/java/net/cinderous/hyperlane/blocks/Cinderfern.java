...
public class Cinderfern extends DoublePlantBlock {
    public static final EnumProperty<DoubleBlockHalf> HALF = BlockStateProperties.DOUBLE_BLOCK_HALF;

    public Cinderfern(Block.Properties properties) {
...
//        BlockState plant = plantable.getPlant(world, pos.offset(facing));
        ...
        if (state.getBlock() == this && blockstate == RegistryHandler.CINDIRT.get().getDefaultState() || state.getBlock() == this && blockstate == RegistryHandler.CINDIRT_GRASS.get().getDefaultState()) {
