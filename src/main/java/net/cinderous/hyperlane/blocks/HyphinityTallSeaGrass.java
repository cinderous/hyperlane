...
public class HyphinityTallSeaGrass extends ShearableDoublePlantBlock implements ILiquidContainer {
    public static final EnumProperty<DoubleBlockHalf> field_208065_c = ShearableDoublePlantBlock.PLANT_HALF;
    protected static final VoxelShape SHAPE = Block.makeCuboidShape(2.0D, 0.0D, 2.0D, 14.0D, 16.0D, 14.0D);

    public HyphinityTallSeaGrass(Block.Properties p_i49970_1_) {
        super(p_i49970_1_);
    }
