package net.cinderous.hyperlane.containers;

import net.cinderous.hyperlane.tileentities.HyperlaneStaffPedestalTileEntity;
...
public class HyperlaneStaffPedestalContainer extends Container {

    public final HyperlaneStaffPedestalTileEntity tileEntity;
     ...
     * hotbar.
     */
    public HyperlaneStaffPedestalContainer(final int windowId, final PlayerInventory playerInv,
                                 final HyperlaneStaffPedestalTileEntity tileEntityIn) {
        super(RegistryHandler.HYPERLANE_STAFF_PEDESTAL_CONTAINER.get(), windowId);
    ...
    public HyperlaneStaffPedestalContainer(final int windowId, final PlayerInventory playerInv, final PacketBuffer data) {
     ...
     * happen.
     */
    private static HyperlaneStaffPedestalTileEntity getTileEntity(final PlayerInventory playerInv, final PacketBuffer data) {
        Objects.requireNonNull(playerInv, "playerInv cannot be null");
        Objects.requireNonNull(data, "data cannot be null");
        final TileEntity tileAtPos = playerInv.player.world.getTileEntity(data.readBlockPos());
        if (tileAtPos instanceof HyperlaneStaffPedestalTileEntity) {
            return (HyperlaneStaffPedestalTileEntity) tileAtPos;
        }
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(canInteractWithCallable, playerIn, RegistryHandler.HYPERLANE_STAFF_PEDESTAL.get());
    }
