...
public class HyperlaneStaffPedestalTileEntity  extends LockableLootTileEntity implements IClearable, INamedContainerProvider {
    ...
    public HyperlaneStaffPedestalTileEntity(TileEntityType<?> tileEntityTypeIn) {
        super(tileEntityTypeIn);
    }

    public HyperlaneStaffPedestalTileEntity() {
        this(RegistryHandler.HYPERLANE_STAFF_PEDESTAL_TILE_ENTITY.get());
    }
    ...
    protected ITextComponent getDefaultName() {
        return new TranslationTextComponent("container." + Hyperlane.MOD_ID + ".item_pedestal");
    }

    /* This method creates the container for this tile entity */
    @Override
    protected Container createMenu(int id, PlayerInventory player) {
        return new HyperlaneStaffPedestalContainer(id, player, this);
    }
