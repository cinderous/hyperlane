...
public class HyperlaneStaffPedestalRenderer extends TileEntityRenderer<HyperlaneStaffPedestalTileEntity> {

    private float degrees;

    public HyperlaneStaffPedestalRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
     ...
     */
    @Override
    public void render(HyperlaneStaffPedestalTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn,
