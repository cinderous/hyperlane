...
public class CinderlingShell extends Item {
    private final Fluid containedBlock;

    // Forge: Use the other constructor that takes a Supplier
    @Deprecated
    public CinderlingShell(Fluid containedFluidIn, Item.Properties builder) {
        super(builder);
     ...
     */
    public CinderlingShell(java.util.function.Supplier<? extends Fluid> supplier, Item.Properties builder) {
        super(builder);
                ...
                if (this.containedBlock == Fluids.EMPTY) {
                    ...
                    if (blockstate1.getBlock() instanceof IBucketPickupHandler) {
                        ...
                        if (fluid != Fluids.EMPTY && fluid == Fluids.WATER) {
                            ...
                            ItemStack itemstack1 = this.fillBucket(itemstack, playerIn, RegistryHandler.CINDERLING_SHELL_WATER.get());
                            if (!worldIn.isRemote) {
    ...
    protected ItemStack emptyBucket(ItemStack p_203790_1_, PlayerEntity p_203790_2_) {
        return !p_203790_2_.abilities.isCreativeMode ? new ItemStack(RegistryHandler.CINDERLING_SHELL.get()) : p_203790_1_;
    }
    ...
    public net.minecraftforge.common.capabilities.ICapabilityProvider initCapabilities(ItemStack stack, @Nullable net.minecraft.nbt.CompoundNBT nbt) {
        if (this.getClass() == CinderlingShell.class)
