...
//    }
    ...
    public static void registerPlacementTypes() {
        registerPlacementType(RegistryHandler.CINDERLING.get(), EntitySpawnPlacementRegistry.PlacementType.NO_RESTRICTIONS);
    }

    @Override
    public AgeableEntity createChild(AgeableEntity ageable) {
        HyphinityWisp entity = new HyphinityWisp(RegistryHandler.HYPHINITY_WISP.get(), this.world);
    ...
    public void tick() {
        super.tick();
//
//        BlockPos self = new BlockPos (this.getPosition().getX(), this.getPosition().getY(), this.getPosition().getZ());
//
//        PlayerEntity closestplayer = this.world.getClosestPlayer(self.getX(),self.getY(),self.getZ(), 100, false);
//        if (closestplayer == null) {
//            CrystalArchitect.LOGGER.info("closest player is null");
//            this.damageEntity(DamageSource.DROWN, 100);
//        }
...
//            return worldIn.getBlockState(this.getPosition()).getBlock() == RegistryHandler.HYPHINITY_ORE.get();
//        }
        return true;//worldIn.getBlockState(this.getPosition().down()).getBlock() == RegistryHandler.HYPHINITY_ORE.get();
    }
