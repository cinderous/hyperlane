...
//    }
    ...
    public HyphinityWisp(EntityType<? extends AnimalEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    public static void registerPlacementTypes() {
        registerPlacementType(RegistryHandler.HYPHINITY_WISP.get(), EntitySpawnPlacementRegistry.PlacementType.NO_RESTRICTIONS);
    }
