package net.cinderous.hyperlane.client.gui;
...
public class HyperlaneStaffPedastalScreen extends ContainerScreen<HyperlaneStaffPedestalContainer> {

    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(Hyperlane.MOD_ID,
            "textures/gui/hyperlane_staff_pedastal.png");
     ...
     */
    public HyperlaneStaffPedastalScreen(HyperlaneStaffPedestalContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
