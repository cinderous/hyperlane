...
public class HyphinityFlowerFeature extends FlowersFeature<BlockClusterFeatureConfig> {
    public HyphinityFlowerFeature(Function<Dynamic<?>, ? extends BlockClusterFeatureConfig> p_i49889_1_) {
        super(p_i49889_1_);
    }
