...
import net.cinderous.hyperlane.world.feature.HyphinityFlowerFeature;
import net.cinderous.hyperlane.world.feature.HyphinitySeaGrassFeature;
import net.cinderous.hyperlane.world.feature.HyphinitySeaGrassFeatureConfig;
import net.cinderous.hyperlane.world.feature.HyphinityTree;
...
public class HyphinityLimbo extends Biome {
...
//            new SimpleBlockStateProvider(RegistryHandler.CINDERITE_ROCK.get().getDefaultState()), new SimpleBlockPlacer())).tries(5).build();
    ...
    public HyphinityLimbo(Biome.Builder biomeBuilder) {
        super(biomeBuilder);
