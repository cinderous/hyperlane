...
public class HyphinityChunkGenerator   extends NoiseChunkGenerator<HyphinityGenSettings> {
   // private final BlockPos spawnPoint;

    public HyphinityChunkGenerator(IWorld worldIn, BiomeProvider biomeProviderIn, HyphinityGenSettings settingsIn) {
    ...
    protected void fillNoiseColumn(double[] noiseColumn, int noiseX, int noiseZ) {
        ...
        this.calcNoiseColumn(noiseColumn, noiseX, noiseZ, 1368.824D, 684.412D, 17.110300000000002D, 4.277575000000001D, 120, -3000);
    }
