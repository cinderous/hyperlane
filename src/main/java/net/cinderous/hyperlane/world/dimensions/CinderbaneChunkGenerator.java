...
public class CinderbaneChunkGenerator  extends NoiseChunkGenerator<CinderbaneGenSettings> {
    ...
    public CinderbaneChunkGenerator(IWorld worldIn, BiomeProvider biomeProviderIn, CinderbaneGenSettings settingsIn) {
        super(worldIn, biomeProviderIn, 8, 2, 128, settingsIn, true);
    ...
    protected void fillNoiseColumn(double[] noiseColumn, int noiseX, int noiseZ) {
        ...
        this.calcNoiseColumn(noiseColumn, noiseX, noiseZ, 668.824D, 384.412D, 8.110300000000002D, 2.277575000000001D, 64, -3000);
    }
