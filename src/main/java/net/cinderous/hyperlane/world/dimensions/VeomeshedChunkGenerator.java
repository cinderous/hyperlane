...
public class VeomeshedChunkGenerator   extends NoiseChunkGenerator<VeomeshedGenSettings> {
    private final BlockPos spawnPoint;

    public VeomeshedChunkGenerator(IWorld worldIn, BiomeProvider biomeProviderIn, VeomeshedGenSettings settingsIn) {
