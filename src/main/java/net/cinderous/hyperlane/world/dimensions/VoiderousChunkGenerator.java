...
public class VoiderousChunkGenerator   extends NoiseChunkGenerator<VoiderousGenSettings> {
    // private final BlockPos spawnPoint;

    public VoiderousChunkGenerator(IWorld worldIn, BiomeProvider biomeProviderIn, VoiderousGenSettings settingsIn) {
